...
<article id="products">
    ...
    <section><strong>BeanExplorer</strong> — созданная нами технология для автоматической генерации интерактивных пользовательских
        ...
        <strong>BeanExplorer</strong> позволяет свести к нулю программирование форм пользовательского интерфейса (таблиц,
    ...
    <section><strong>BioUML</strong> — расширяемая открытая система на языке Java, адаптирующая подход визуального моделирования
    ...
    <section>Единый портал <strong>ЖКХ "Мой дом"</strong> призван обеспечить защищенное и удобное для работы информационное
    ...
    <section>Одним из приоритетных направлений развития любого региона является создание информационной системы
        ...
        комплексной модели управления территорией. <br><strong>Территориальный информационный комплекс «Регион»</strong> — это
...
<div class="loginForm" id="loginForm">
    <form name="Форма авторизации" method="post" action="">
